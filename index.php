...
<html lang="en">
  <head>
    ...
    <title>The Ski Locker - Co-working space in Chamonix</title>
        ...
        <div class="content">
    		...
    		<div id="hero-panels" class="gallery row">
    		  <ul>
      		  ...
      		  <li class="col-md-4 col-sm-4 col-xs-12 mix locker" data-cat="locker">
                <a href="team.html#team" class="mix-cover gray">
                  <span class="valign"></span>
          ...
          <div class="section">
            <div class="row">
              <div class="col-md-5 col-sm-5 col-xs-12">
                ...
                <p>The Ski Locker is a shared co-working space created by a group of entrepreneurs trying to make our living in Chamonix. Most of us at the Ski Locker have been working in London, Stockholm or Paris;
                  Cities are nice, but not a great creative environment for mountain lovers like us. We quickly noticed the importance of using our passion for the mountains as a key to unlock our creativity and well-being.<br/>
        ...
        <div class="section">
          <div id="team" class="row">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                <img class="slide-in left img-responsive" src="img/theskilocker-worker.jpg" alt="Working at the Ski Locker in Chamonix">
              </div>
            </div>
          </div> <!-- /#team -->
        </div>
        <div class="section">
          <div class="row last">
            <div class="col-md-5 col-sm-5 col-xs-12">
              ...
              <p>Chamonix is not like other ski resorts; it is active and full of life all year round. Many of the activities are about sport but we also have cultural events like the Cosmo Jazz festival or the Yoga festival during summer.</p>
                <h2>Winter</h2>
                <p>When most people think about Chamonix, they think about deep powder turns and great skiers riding down steep slopes or couloirs, but that's only a small part of what Chamonix has to offer.
                  <br/>The Aiguille du Midi cable car, only 100m from the Ski Locker, gives you access to famous off-piste skiing like the "Vallée Blanche" or steeper runs like the Couloir des Cosmiques and the Glacier Rond. Of course, if you are a fan of pizza you can simply ski tour cross the Italian border and have lunch there!</p>
                <h2>Summer</h2>
                <p>You might be surprised to learn that Chamonix is more popular in the summer than the winter! When you visit Chamonix you won't be surprised why. The cold mountains warm up and it's possible to hike, trail-run and mountain bike long distances all over the valley.
                  <br/>Chamonix is not only famous for its winter sports; the climbing, and alpinism in general, is very popular with mountaineers from all over the world.</p>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12">
    ...
    <div id="pricing" class="section">
      <div class="fixed-container">
        <div class="content text-center">
          ...
          <p>All prices are PER MONTH and EXCLUDE VAT 25%</p><br /><br /><br /><br />
          <div class="pricing">
            <div class="row">
    ...
    <div id="pricing-short-term" class="section">
      <div class="fixed-container">
        <div class="content text-center">
          ...
          <p>All prices EXCLUDE VAT 25%</p><br /><br /><br /><br />
          <div class="pricing">
            <div class="row">
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <p>The Ski Locker was created to give creative people living and visiting Chamonix the chance to meet, ski and work together. Everyone is welcome, even if you just want to hang out.
              <br />
            </p>
